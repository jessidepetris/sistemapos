...
import { BarChart3, Download, FileText, LineChart as LineChartIcon, PieChartIcon, TrendingUp } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { ProfitReport } from "@/components/ui/profit-report";
        ...
        <main className="flex-1 overflow-auto p-6">
                ...
                <div>
                  ...
                  <Select value={reportType} onValueChange={setReportType}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="profits">Ganancias</SelectItem>
          ...
          {reportType === "products" && (
            <div className="text-center py-10">
              ...
              <p className="text-muted-foreground">Seleccione un rango de fechas para generar el reporte</p>
            </div>
          )}
          
          {reportType === "customers" && (
            <div className="text-center py-10">
              <h3 className="text-lg font-medium">Reporte de Clientes</h3>
              <p className="text-muted-foreground">Seleccione un rango de fechas para generar el reporte</p>
            </div>
          )}
